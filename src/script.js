function refreshWeather(response) {
    ...
    let temperature = response.data.temperature.current; // Ensure this matches the API response structure
...
function searchCity(city) {
    let apiKey = '180afbft0d9bbd63o1e48164442b604a';
